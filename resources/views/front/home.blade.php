            ...
            <div class="col-md-7">
                <div class="feature_article_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive top_static_article_img" src="{{ asset('public/post') }}/{{ $hot_news->main_image }}"
                             alt="{{ $hot_news->title }}">
                    </div>
                    <!-- feature_article_img -->
                    ...
                    <div class="feature_article_inner">
                        ...
                        <div class="feature_article_date">
                            ...
                            <a href="#">{{ date('F j,Y',strtotime($hot_news->created_at)) }}</a>
                        </div>
            ...
            @foreach($top_viewed as $item)
                <div class="col-md-5" style="margin-bottom: 3%">
                    <div class="feature_static_wrapper">
                        <div class="feature_article_img">
                            <img class="img-responsive" width="500px" style="height: 270px" src="{{ asset('public/post') }}/{{ $item->main_image }}" alt="{{ $item->title }}">
                        </div>
                        <!-- feature_article_img -->
                        ...
                        <div class="feature_article_inner">
                            ...
                            <div class="feature_article_content">
                                {{ str_limit($item->short_description,40,'...') }}
                            </div>
                            <!-- feature_article_content -->
                        ...
                        <div class="col-md-6">
                            <div class="top_article_img">
                                <a href="{{ url('/details') }}/{{ $item->slug }}">
                                    <img class="img-responsive" src="{{ asset('public/post') }}/{{ $item->list_image }}" alt="{{ $item->title }}">
                                </a>
                            </div>
                            <!----top_article_img------>
                        </div>
                                ...
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <h3 class="media-heading">
                                            <a href="{{ url('/details') }}/{{ $item->slug }}" target="_self">{{ $item->title }}</a></h3>
