...
<head>
    ...
    <title>{{ $sharedData['system_name'] }}</title>
    <meta name="description" content="Sufee Admin - HTML5 Admin Template">
    <meta name="viewport" content="width=device-width, initial-scale=1">

    <link rel="apple-touch-icon" href="{{ asset('public/others') }}/{{ $sharedData['favicon'] }}">
    <link rel="shortcut icon" href="{{ asset('public/others') }}/{{ $sharedData['favicon'] }}">
        ...
        <div class="container">
            <div class="login-content">
                <div class="login-logo">
                    <a href="index.html">
                        <img class="align-content" src="{{ asset('public/others') }}/{{ $sharedData['admin_logo'] }}" alt="">
                    </a>
                </div>
