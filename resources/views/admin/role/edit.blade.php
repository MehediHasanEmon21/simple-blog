                      ...
                      <div class="card-body">
                          ...
                          {!! Form::model($role,['route' => ['role-update',$role->id],'method'=>'put']) !!}
                              ...
                              <div class="form-group">
                                  ...
                                  {!! Form::text('display_name',null,['class'=>'form-control','id'=>'name']) !!}
                              </div>
                              <div class="form-group">
                              ...
                              <div class="form-group">
                                  ...
                                  {!! Form::select('permissions[]',$permissions,$selectedPermissions,['class'=>'myselect','data-placeholder'=>'Select Permission(s)','multiple']) !!}
                              </div>
                              <div>
