        ...
        <div class="row">
            <div class="col-md-7">
                <div class="feature_article_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive top_static_article_img" src="{{ asset('public/front/img/feature-top.jpg') }}"
                             alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
            ...
            <div class="col-md-5">
                <div class="feature_static_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" src="{{ asset('public/front/img/feature-static1.jpg') }}" alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
            ...
            <div class="col-md-5">
                <div class="feature_static_last_wrapper">
                    <div class="feature_article_img">
                        <img class="img-responsive" src="{{ asset('public/front/img/feature-static2.jpg')}}" alt="feature-top">
                    </div>
                    <!-- feature_article_img -->
            ...
            <div class="col-md-6">
                <div class="top_article_img">
                    <a href="single.html" target="_self"><img class="img-responsive"
                                                               src="{{ asset('public/front/img/cat-mobi-left-1.jpg') }}" alt="feature-top">
                    </a>
                </div>
                <!----top_article_img------>
            </div>
    ...
    <div class="category_article_wrapper">
        <div class="row">
            <div class="col-md-6">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('public/front/img/cat-mobi-sm1.jpg')}}"
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('public/front/img/cat-mobi-sm3.jpg') }}"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple">Mobile</span>
            ...
            <div class="col-md-6">
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('public/front/img/cat-mobi-sm2.jpg') }}"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple">Mobile</span>
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('public/front/img/cat-mobi-sm4.jpg') }}"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <span class="tag purple">Mobile</span>
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self"><img class="img-responsive" src="{{ asset('public/front/img/tab_top1.jpg') }}"
                                                                   alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
                ...
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="{{ asset('public/front/img/tab_top2.jpg') }}" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="{{ asset('public/front/img/gad_top1.jpg') }}" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
            ...
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <img class="img-responsive" src="{{ asset('public/front/img/gad_top2.jpg') }}" alt="feature-top">
                    </div>
                    <!-- top_article_img -->
    ...
    <div class="category_article_wrapper">
        <div class="row">
            <div class="col-md-5">
                <div class="top_article_img">
                    <a href="single.html" target="_self">
                        <img class="img-responsive" src="{{ asset('public/front/img/cam_left1.jpg' ) }}" alt="feature-top">
                    </a>
                </div>
                <!-- top_article_img -->
    ...
    <div class="category_article_wrapper">
        <div class="row">
            <div class="col-md-5">
                <div class="top_article_img">
                    <a href="single.html" target="_self">
                        <img class="img-responsive" src="{{ asset('public/front/img/cam_left2.jpg') }}" alt="feature-top">
                    </a>
                </div>
                <!-- top_article_img -->
    ...
    <div class="category_article_wrapper">
        <div class="row">
            <div class="col-md-5">
                <div class="top_article_img">
                    <a href="single.html" target="_self">
                        <img class="img-responsive" src="{{ asset('public/front/img/cam_left3.jpg' ) }}" alt="feature-top">
                    </a>
                </div>
                <!-- media_social -->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="{{ asset('public/front/img/design_top1.jpg')}}" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
            ...
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="{{ asset('public/front/img/design_top2.jpg') }}" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
        ...
        <div class="row">
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <a href="single.html" target="_self">
                            <img class="img-responsive" src="{{ asset('public/front/img/design_top3.jpg' ) }}" alt="feature-top">
                        </a>
                    </div>
                    <!-- top_article_img -->
            ...
            <div class="col-md-6">
                <div class="category_article_body">
                    <div class="top_article_img">
                        <img class="img-responsive" src="{{ asset('public/front/img/design_top4.jpg') }}" alt="feature-top">
                    </div>
                    <!-- top_article_img -->
...
<div class="widget">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#"><img class="media-object" src="{{ asset('public/front/img/pop_right1.jpg') }}" alt="Generic placeholder image"></a>
        </div>
        <div class="media-body">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#"><img class="media-object" src="{{ asset('public/front/img/pop_right2.jpg') }}" alt="Generic placeholder image"></a>
        </div>
        <div class="media-body">
            <h3 class="media-heading">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#"><img class="media-object" src="{{ asset('public/front/img/pop_right3.jpg') }}" alt="Generic placeholder image"></a>
        </div>
        <div class="media-body">
            <h3 class="media-heading">
    ...
    <div class="media">
        <div class="media-left">
            <a href="#"><img class="media-object" src="{{ asset('public/front/img/pop_right4.jpg') }}" alt="Generic placeholder image"></a>
        </div>
        <div class="media-body">
            <h3 class="media-heading">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <div class="logo footer-logo">
                    <a title="fontanero" href="index.html">
                        <img src="{{ asset('public/front/img/tech_about.jpg') }}" alt="technews">
                    </a>
            ...
            <div class="col-md-3">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('public/front/img/editor_pic1.jpg')}}"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('public/front/img/editor_pic2.jpg' )}} "
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
                ...
                <div class="media">
                    <div class="media-left">
                        <a href="#"><img class="media-object" src="{{ asset('public/front/img/editor_pic3.jpg') }}"
                                         alt="Generic placeholder image"></a>
                    </div>
                    <div class="media-body">
                        <h3 class="media-heading">
            ...
            <div class="col-md-3">
                ...
                <div class="widget_photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo1.jpg') }}" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo2.jpg') }}" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo3.jpg') }}" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo4.jpg') }}" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo5.jpg') }}" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo6.jpg') }}" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo7.jpg') }}" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo8.jpg') }}" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo9.jpg') }}" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo10.jpg') }}" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo11.jpg') }}" alt="Tech Photos">
                    <img class="img-thumbnail" src="{{ asset('public/front/img/tech_photo12.jpg') }}" alt="Tech Photos">
                </div>
...
<!-- Theme Menu -->
<script src="{{ asset('public/front/js/mobile-menu.js') }}"></script>
